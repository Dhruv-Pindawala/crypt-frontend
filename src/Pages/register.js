        ...
        <div className='loginContainer'>
            <div className='inner'>
                ...
                <div className='title'>Sign up</div>
                    <AuthForm data={registerData} onSubmit={submit} onChange={onChange} showPassword={showPassword} setShowPassword={setShowPassword} error={error} setError={setError} loading={loading} />

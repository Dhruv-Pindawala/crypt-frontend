...
const Home = (props) => {
    ...
    return (
        ...
        {activeUser && <ProfileModal {...props} close={() => setShowProfileModal(false)} userDetail={activeChatUser} visible={showProfileModal} closable={true} setClosable={() => null} view />}
        <div className='home-container'>
            <div className='side close' id="sideBar">
                <div className='flex align-center justify-between top'>
                    ...
                    <div>
                        <img src={settings} onClick={() => { setShowProfile(true); closeSideBar(); }} /><div className="mobile">&nbsp;&nbsp;&nbsp;&nbsp; <img src={close} alt="" onClick={toggleSideBar} style={{width:15}} /></div></div>
                </div>
                <UserList />
            ...
            <div className='main'>
                {activeUser ? <ChatInterface activeUser={activeUser} loggedUser={userdetail} toggleSideBar={toggleSideBar} showProfileModal={showProfileModal} setShowProfileModal={setShowProfileModal} /> : <div><div className="heading mobile"><div style={{height="100%"}} className="flex align-center"><img src={menu} alt="" onClick={toggleSideBar} />&nbsp;&nbsp;</div></div><div className='noUser'>Click on a user to start chatting</div></div>}
            </div>
        </div>
        </>
    );
